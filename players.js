const players = {
  "jung-jiseok": {
    ...
    team: "대한항공 점보스",
    position: "아웃사이드 히터",
    photo: "player-photos/details/jung-jiseok.jpg",
    records: [
  ...
  "heo-subong": {
    ...
    team: "현대캐피탈 스카이워커스",
    position: "아웃사이드 히터",
    photo: "player-photos/details/heo-subong.jpg",
    records: [
  ...
  "hwang-taegui": {
    ...
    team: "KB손해보험",
    position: "세터",
    photo: "player-photos/details/hwang-taegui.jpg",
    records: ["2016-17 V-리그 신인상", "2023 아시아 챌린지컵 베스트 세터", "대한민국 남자배구 국가대표"],
  ...
  "lim-donghyeok": {
    ...
    team: "대한항공 점보스",
    position: "아포짓 스파이커",
    photo: "player-photos/details/lim-donghyeok.jpg",
  ...
  "cho-jaeyoung": {
    ...
    team: "대한항공 점보스",
    position: "미들 블로커",
    photo: "player-photos/details/cho-jaeyoung.jpg",
    records: ["AVC 챌린저컵 남자배구 국가대표", "2023-24 챔피언결정전 우승", "2023-24 정규시즌 우승", "2022 KOVO컵 우승"],
  ...
  "kim-minjae": {
    ...
    team: "대한항공 점보스",
    position: "미들 블로커",
    photo: "player-photos/details/kim-minjae.jpg",
    records: ["아시아 남자배구 선수권대회 국가대표", "AVC컵 남자배구 국가대표", "V-리그 베스트7 이력", "대한항공 우승 멤버"],
  ...
  "lim-sungjin": {
    ...
    team: "KB손해보험",
    position: "아웃사이드 히터",
    photo: "player-photos/details/lim-sungjin.jpg",
    records: ["2024 AVC컵 남자배구 국가대표", "2024 KOREA컵 국제 남자배구 국가대표", "2023 아시아 남자배구 선수권대회 국가대표", "FIVB 챌린저컵 남자배구 국가대표"],
  ...
  "jeon-jinseon": {
    ...
    team: "한국전력 빅스톰",
    position: "미들 블로커",
    photo: "player-photos/details/jeon-jinseon.jpg",
  ...
  "park-gyeongmin": {
    ...
    team: "현대캐피탈 스카이워커스",
    position: "리베로",
    photo: "player-photos/details/park-gyeongmin.jpg",
  ...
  "oh-eunryeol": {
    ...
    team: "현대캐피탈 스카이워커스",
    position: "리베로",
    photo: "player-photos/details/oh-eunryeol.jpg",
  ...
  "lim-jaeyoung": {
    ...
    team: "대한항공 점보스",
    position: "아웃사이드 히터",
    photo: "player-photos/details/lim-jaeyoung.jpg",
    records: ["상세 국가대표 및 수상 이력 추가 확인 예정"],
  ...
  "han-sungjeong": {
    ...
    team: "우리카드 우리WON",
    position: "아웃사이드 히터",
    photo: "player-photos/details/han-sungjeong.jpg",
    records: ["상세 국가대표 및 수상 이력 추가 확인 예정"],
  ...
  "kim-youngjun": {
    ...
    team: "우리카드 우리WON",
    position: "리베로",
    photo: "player-photos/details/kim-youngjun.jpg",
    records: ["상세 국가대표 및 수상 이력 추가 확인 예정"],
  ...
  "park-changseong": {
    ...
    team: "OK저축은행 읏맨",
    position: "미들 블로커",
    photo: "player-photos/details/park-changseong.jpg",
    records: ["상세 국가대표 및 수상 이력 추가 확인 예정"],
  ...
  "lee-sanghyeon": {
    ...
    team: "우리카드 우리WON",
    position: "미들 블로커",
    photo: "player-photos/details/lee-sanghyeon.jpg",
    records: ["상세 국가대표 및 수상 이력 추가 확인 예정"],
  ...
  "kim-dohun": {
    ...
    team: "KB손해보험",
    position: "리베로",
    photo: "player-photos/details/kim-dohun.jpg",
    records: ["상세 국가대표 및 수상 이력 추가 확인 예정"],
  ...
  "park-juhyeong": {
    ...
    team: "현대캐피탈 스카이워커스",
    position: "아웃사이드 히터",
    photo: "player-photos/details/park-juhyeong.jpg",
